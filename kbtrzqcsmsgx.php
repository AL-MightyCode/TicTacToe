...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=371231');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "371231");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "44065d237e03026b4a161baad5274e5eeda0a2cac477881e216d50f6a3f41a7c");
define('CREATED_TIMESTAMP', "1741769373");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor371231');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor371231');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "tictactoe-rqni.onrender.com",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "tictactoe-rqni.onrender.com",
));
